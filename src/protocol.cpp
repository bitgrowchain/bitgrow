...
static unsigned char pchMessageStartTestOld[4] = { 0xdc, 0xe1, 0xf2, 0xf6 };
static unsigned char pchMessageStartTestNew[4] = { 0xce, 0xf2, 0xc0, 0xef };
static unsigned int nMessageStartTestSwitchTime = 1346200000;

// bitGrow message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xf8, 0xbe, 0xb4, 0xd9 };
static unsigned char pchMessageStartbitGrow[4] = { 0xe5, 0xe8, 0xe9, 0xe5 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartbitGrow : pchMessageStartBitcoin, sizeof(pchMessageStartbitGrow));
}
