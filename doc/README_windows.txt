Peercoin (bitGrow) 0.5.4 BETA

Copyright (c) 2011-2016 Peercoin (bitGrow) Developers
...
Intro
-----
Peercoin (bitGrow) is a free open source project derived from Bitcoin, with
...
incoming connections.  bitGrow works without incoming connections,
but allowing incoming connections helps the bitGrow network.
